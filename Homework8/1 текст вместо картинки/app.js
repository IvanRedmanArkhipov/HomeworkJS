...
function handleClick(clickedButtonEvent) {
    ...
    const card = {
        ...
        img: cardNode.querySelectorAll('img'), // здесь картинка внутри .product
        productName: cardNode.querySelectorAll('.productName'), // здесь .productName, который внутри .product
        button: cardNode.querySelectorAll('button'), // здесь button, который внутри .product
    };
...
function showMoreText(card) {
    ...
    let description = "Сижу за решеткой в темнице сырой. Вскормленный в неволе орел молодой, Мой грустный товарищ, махая крылом, Кровавую пищу клюет под окном,"
